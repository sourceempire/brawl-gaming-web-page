...
const Section3 = () => {
  ...
  const gameArray = [
    ...
    {id:2, title:'FIFA 19', img_back:'fifa19_back.png',modes:[{ id:1, mode:'Team deathmatch' }, {id:2, mode:'3 vs 3'}] },
    {id:3, title:'Rocket League', img_back:'fifa19_back.png', modes:[{ id:1, mode:'1 vs 1' }, {id:2, mode:'5 vs 5'}] }
    ]
  return (
    <div>
      <div className="Games">
