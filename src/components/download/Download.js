    ...
    <section>
      <div id="dl">
        <div className="logoDiv">
          ...
          <div id="logoText"><h4>Brawl</h4><h4>Gaming</h4></div>
        </div>
        <p id="slogan">Brawl Gaming is the ultimate way to earn money while gaming.</p>
        <button id="dlBtn" onClick={downloadPrimary}>
          <h3 id="dlText">Download</h3>
          <img className="dlBtnImg" src={osImg1} alt="current os"></img>
        </button>
        <div className="dlAlt">
          <p id="altTxt">Also available on: </p>
          <img className="dlBtnImg" id="alt" src={osImg2} onClick={downloadSecondary} alt="alternative os"/>
        </div>
      </div>
